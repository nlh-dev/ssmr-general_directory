            ...
            <div>
                <h1 class="text-lg font-semibold text-left">
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-400">
                        Listado de Switches de Red Distribuidos en el Hospital Madre Rafols.
                    </p>
                </h1>
            </div>
            <div class="flex items-center gap-x-2">
                <div>
                    <button data-popover-target="addSwitchPopover" data-popover-placement="top" data-modal-target="addSwitchBrand" data-modal-toggle="addSwitchBrand" class="flex items-center text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-4 py-2 text-center transition duration-100" type="button">
                    ...
                    <div data-popover id="addSwitchPopover" role="tooltip"
                        ...
                        <div class="px-3 py-2 bg-gray-900 rounded-lg">
                            <h3 class="font-semibold text-white text-xs">Añadir Marca</h3>
                        </div>
                        <div data-popper-arrow bg-gray-900></div>
                    </div>
                </div>

                <button data-modal-target="addSwitch" data-modal-toggle="addSwitch" class="flex items-center text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition duration-100" type="button">

        ...
        <div class="relative rounded-lg shadow-sm bg-gray-900">
            ...
            <form action="#" class="AjaxForm" method="POST" autocomplete="OFF">
                ...
                <div class="p-4 bg-white grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="">
                        <label for="observationRerason" class="flex items-center block text-sm font-medium text-gray-900">
                        ...
                        <div class="relative my-2">
                            <input type="text" id="observationRerason" name="observationRerason" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Recibido por....">
                        </div>
                    </div>
                    <div class="">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="observationDescription" rows="5" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Descripción..."></textarea>
                    </div>
                </div>
                <!-- Modal footer -->
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('[data-modal-hide="addObservation"]').forEach(function(btn) {

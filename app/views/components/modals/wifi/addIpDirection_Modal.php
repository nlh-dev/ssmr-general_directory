<div id="addIpDirection" tabindex="-1" class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full animate__animated animate__fadeInDownBig md:mx-2">
        ...
        <div class="relative rounded-lg shadow-sm bg-gray-900">
            ...
            <div class="flex items-center p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                <div class="flex items-center">
                    ...
                    <div class="flex-col">
                        <span id="ipDirectionModalTitle" class="text-xl font-medium text-white"></span>
            ...
            <form action="<?= $AjaxRoutes['wifiPasswords'] ?>" class="AjaxForm" method="POST" autocomplete="OFF">
                ...
                <div class="p-4 bg-white grid grid-cols-1 gap-5">
                    <div class="">
                        <label for="ipDirection" class="flex items-center block text-sm font-medium text-gray-900">
                            ...
                            Dirección IP / Dirección de Acceso<span class="text-gray-500 ms-1">(Opcional)</span>
                        </label>
                ...
                <div class="w-full flex items-center justify-end p-4 md:p-5 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b">
                    <button data-modal-hide="addIpDirection" type="button" class="AjaxForm px-3 py-2 text-sm font-medium text-center inline-flex items-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 mr-3">

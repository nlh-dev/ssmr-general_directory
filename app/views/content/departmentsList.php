<div class="p-4 sm:ml-64 content-main transition-all duration-100">
    <div class="p-2 mt-10">
        ...
        <div class="flex items-center justify-between text-gray-800 pb-4">
            <div>
                <h1 class="text-lg font-semibold text-left">
                    Departamentos
                    <p class="mt-1 text-sm font-normal text-gray-400">Listado de los Departamentos pertenecientes al Sistema de Salud Madre Rafols.</p>
                </h1>
            </div>
            <div class="">
        ...
        <?php require_once "./app/views/components/tables/departmentsListTable.php" ?>

...
<div class="p-4 sm:ml-64 content-main transition-all duration-100">
    <div class="p-2 mt-10">
        <div class="my-4">
            <?php require_once "./app/views/components/breadcrumbs/storageListBreadcrumb.php" ?>
        ...
        <div class="flex items-center justify-between text-gray-800 pb-4">
            <div>
                <h1 class="text-lg font-semibold text-left">
                    Existencias
                    <p class="mt-1 text-sm font-normal text-gray-400">Listado de Existencias de Inventario del Departamento de Informática del Hospital Madre Rafols.</p>
                </h1>
            </div>
            <div class="flex items-center space-x-2">
                <div>
                    ...
                    <div data-popover id="addCategory" role="tooltip"
                        ...
                        <div class="px-3 py-2 bg-gray-900 rounded-lg">
                            <h3 class="font-semibold text-white text-xs">Añadir Categoría</h3>
                        </div>
                        <div data-popper-arrow bg-gray-900></div>
                    </div>
                </div>
                <div>
                    <button data-popover-target="addType" data-popover-placement="bottom" data-modal-target="addStorageType" data-modal-toggle="addStorageType" class="flex items-center text-white bg-gray-900 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2 text-center transition duration-100" type="button">
                        <svg class="w-6 h-6" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
